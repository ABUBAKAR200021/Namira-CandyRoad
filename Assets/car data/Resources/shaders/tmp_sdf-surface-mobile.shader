			...
			Program "vp" {
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat19);
					    u_xlat19 = dot(u_xlat3.xyw, u_xlat8.xyz);
					    vs_TEXCOORD5.y = abs(u_xlat19) * u_xlat18 + u_xlat2.x;
					    vs_TEXCOORD2.w = u_xlat1.x;
					    ...
					    u_xlat18 = u_xlat2.y * u_xlat3.w;
					    u_xlat18 = u_xlat3.y * u_xlat2.z + (-u_xlat18);
