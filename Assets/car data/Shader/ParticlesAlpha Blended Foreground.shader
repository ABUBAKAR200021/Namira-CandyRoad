			...
			Program "vp" {
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = vs_COLOR0.xyz + vs_COLOR0.xyz;
					    u_xlat1.xyz = u_xlat2.xyz * u_xlat10_1.xyz + (-unity_FogColor.xyz);
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = vs_COLOR0.xyz + vs_COLOR0.xyz;
					    u_xlat1.xyz = u_xlat2.xyz * u_xlat16_1.xyz + (-unity_FogColor.xyz);
					    u_xlat10 = vs_TEXCOORD1;
					#ifdef UNITY_ADRENO_ES3
