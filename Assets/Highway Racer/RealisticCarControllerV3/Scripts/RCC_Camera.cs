...
public class RCC_Camera : MonoBehaviour
{
    ...
    public Transform _playerCar { get { return playerCar[PlayerPrefs.GetInt("Selectedcarno")]; } set { playerCar[PlayerPrefs.GetInt("Selectedcarno")] = value; GetPlayerCar(); } }
    ...
    void GetPlayerCar()
    {
        ...
        if (!playerCar[PlayerPrefs.GetInt("Selectedcarno")])
            return;

        // If player car has RCC_CameraConfig, distance and height will be changed.
        if (playerCar[PlayerPrefs.GetInt("Selectedcarno")].GetComponent<RCC_CameraConfig>())
        {
            TPSDistance = playerCar[PlayerPrefs.GetInt("Selectedcarno")].GetComponent<RCC_CameraConfig>().distance;
            TPSHeight = playerCar[PlayerPrefs.GetInt("Selectedcarno")].GetComponent<RCC_CameraConfig>().height;
        }

        ChangeCamera(CameraMode.TPS);

        playerRigid = playerCar[PlayerPrefs.GetInt("Selectedcarno")].GetComponent<Rigidbody>();

        // Getting camera modes from player car.
        hoodCam = playerCar[PlayerPrefs.GetInt("Selectedcarno")].GetComponentInChildren<RCC_HoodCamera>();
        wheelCam = playerCar[PlayerPrefs.GetInt("Selectedcarno")].GetComponentInChildren<RCC_WheelCamera>();
        ...
        transform.position = playerCar[PlayerPrefs.GetInt("Selectedcarno")].transform.position;
        transform.rotation = playerCar[PlayerPrefs.GetInt("Selectedcarno")].transform.rotation * Quaternion.Euler(10f, 0f, 0f);
    ...
    public void SetPlayerCar(GameObject player)
    {
        ...
        playerCar[PlayerPrefs.GetInt("Selectedcarno")] = player.transform;
        GetPlayerCar();
    ...
    void Update()
    {
        ...
        if (!playerCar[PlayerPrefs.GetInt("Selectedcarno")] || !playerRigid)
        {
            GetPlayerCar();
            return;
        }
        ...
        speed = Mathf.Lerp(speed, playerCar[PlayerPrefs.GetInt("Selectedcarno")].InverseTransformDirection(playerRigid.velocity).z * 3.6f, Time.deltaTime * 3f);
    ...
    void LateUpdate()
    {
        ...
        if (!playerCar[PlayerPrefs.GetInt("Selectedcarno")].gameObject.activeSelf)
            return;
    ...
    void TPS()
    {
        ...
        tiltAngle = Mathf.Lerp(0f, maximumTilt * (int)Mathf.Clamp(-playerCar[PlayerPrefs.GetInt("Selectedcarno")].InverseTransformDirection(playerRigid.velocity).x, -1f, 1f), Mathf.Abs(playerCar[PlayerPrefs.GetInt("Selectedcarno")].InverseTransformDirection(playerRigid.velocity).x) / 50f);

        // Calculate the current rotation angles for TPS mode.
        float wantedRotationAngle = playerCar[PlayerPrefs.GetInt("Selectedcarno")].eulerAngles.y;
        float wantedHeight = playerCar[PlayerPrefs.GetInt("Selectedcarno")].position.y + TPSHeight;
        ...
        if (speed < -10)
            wantedRotationAngle = playerCar[PlayerPrefs.GetInt("Selectedcarno")].eulerAngles.y + 180;
        ...
        transform.position = playerCar[PlayerPrefs.GetInt("Selectedcarno")].position;
        ...
        transform.LookAt(new Vector3(playerCar[PlayerPrefs.GetInt("Selectedcarno")].position.x, playerCar[PlayerPrefs.GetInt("Selectedcarno")].position.y + 1f, playerCar[PlayerPrefs.GetInt("Selectedcarno")].position.z));
    ...
    void TOP()
    {
        ...
        targetPosition = playerCar[PlayerPrefs.GetInt("Selectedcarno")].position;
        targetPosition += playerCar[PlayerPrefs.GetInt("Selectedcarno")].rotation * Vector3.forward * distanceOffset;
    ...
    void ORBIT()
    {
        ...
        orbitPosition = orbitRotation * new Vector3(0f, 0f, -TPSDistance) + playerCar[PlayerPrefs.GetInt("Selectedcarno")].position;
    ...
    private void ResetCamera()
    {
        ...
        switch (cameraMode)
        {
            ...
            case CameraMode.TOP:
                ...
                targetPosition += playerCar[PlayerPrefs.GetInt("Selectedcarno")].rotation * Vector3.forward * distanceOffset;
                transform.position = playerCar[PlayerPrefs.GetInt("Selectedcarno")].position;
                pastFollowerPosition = playerCar[PlayerPrefs.GetInt("Selectedcarno")].position;
                pastTargetPosition = targetPosition;
                break;
